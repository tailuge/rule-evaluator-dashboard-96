...
const RuleColumn = ({ rules, onEvaluate, onDelete, isEvaluating }) => {
  const [openItems, setOpenItems] = reactExports.useState([]);
  const toggleItem = (id2) => {
    setOpenItems(
      (current) => current.includes(id2) ? current.filter((item) => item !== id2) : [...current, id2]
    );
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "Rules" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
      rules.map((rule) => /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "p-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Collapsible, { open: openItems.includes(rule.id), children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between gap-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            CollapsibleTrigger,
            {
              ...
              children: [
                openItems.includes(rule.id) ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium text-gray-900", children: rule.title })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                size: "sm",
                children: isEvaluating ? "Evaluating..." : "Evaluate"
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { className: "pt-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600 pl-6", children: rule.details }) })
      ] }) }, rule.id)),
      rules.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 text-center py-4", children: "No rules added yet" })
    ] })
  ] });
};
const ResultsColumn = ({ results }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "Results" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      results.map((result, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Card,
        {
          className: cn(
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-medium", children: result.rule.title }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "px-2 py-1 rounded-full text-sm font-medium", children: result.status })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm", children: result.justification })
          ]
        },
        index2
      )),
      results.length === 0 && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500 text-center py-4", children: "No evaluations yet" })
    ] })
  ] });
};
...
const evaluateRule = async (rule, subject) => {
  var _a2, _b2, _c2;
  ...
  try {
    ...
    throw new Error(((_c2 = (_b2 = (_a2 = error.response) == null ? void 0 : _a2.data) == null ? void 0 : _b2.error) == null ? void 0 : _c2.message) || "Failed to evaluate rule. Please check your API key and try again.");
  }
};
const getCurrentModel = () => "gpt-4o";
const getCurrentPrompt = getSystemPrompt;
const RuleBoard = ({ subject }) => {
  ...
  reactExports.useEffect(() => {
    ...
    window.addEventListener("bulkImportRules", handleBulkImport);
    return () => {
      window.removeEventListener("addRule", handleAddRule);
      window.removeEventListener("bulkImportRules", handleBulkImport);
    };
  }, [rules]);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(ResultsColumn, { results })
    ] })
  ] });
};
...
const APIKeyInput = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Azure API Key" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSave, variant: "outline", children: "Save Key" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-500", children: "Enter your Azure API key to enable rule evaluation" })
  ] });
};
...
const JSONViewer = ({ data, level = 0 }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: { paddingLeft: level > 0 ? "1.5rem" : "0" }, children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Collapsible, { open: isOpen, onOpenChange: setIsOpen, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs(CollapsibleTrigger, { className: "flex items-center gap-1 hover:text-blue-600", children: [
      isOpen ? /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "h-4 w-4" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRight, { className: "h-4 w-4" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: isArray2 ? "[" : "{" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsibleContent, { children: items.map(([key, value], index2) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "py-1", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-gray-700 mr-2", children: !isArray2 && `"${key}":` }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(JSONViewer, { data: value, level: level + 1 })
    ] }) }, key)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: isArray2 ? "]" : "}" })
  ] }) });
};
const SubjectInput = ({ value, onChange }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Subject Matter" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-1 md:grid-cols-2 gap-6", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
        ...
        parseError && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-red-500", children: parseError })
      ] }),
      parsedJSON && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-white p-4 rounded-lg border", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-700 mb-2", children: "JSON Preview" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(JSONViewer, { data: parsedJSON })
      ] })
    ] })
  ] });
};
const AddRuleForm = ({ onAddRule, onBulkImport }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-semibold text-gray-900", children: "Add New Rule" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipProvider, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Tooltip, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TooltipTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              ...
              onClick: () => {
                var _a2;
                return (_a2 = document.getElementById("rule-import")) == null ? void 0 : _a2.click();
              },
              children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs(TooltipContent, { className: "w-[300px]", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "font-medium mb-1", children: "Expected JSON Format:" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("pre", { className: "text-xs bg-slate-100 p-2 rounded", children: sampleJson })
        ] })
      ] }) })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-sm font-medium text-gray-700", children: "Details" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Textarea,
          {
            value: details,
            onChange: (e2) => setDetails(e2.target.value),
            placeholder: "Enter rule details",
            className: "min-h-[100px]"
          }
        )
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { type: "submit", className: "w-full", children: "Add Rule" })
    ] })
  ] });
};
...
const Index = () => {
  ...
  const [prompt, setPrompt] = reactExports.useState(getCurrentPrompt());
  const { toast: toast2 } = useToast();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "min-h-screen bg-gray-50 p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto space-y-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-xl font-semibold text-gray-900 text-center flex-grow", children: "Rule Evaluation Board" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(Sheet, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTrigger, { asChild: true, children: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "icon", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Settings, { className: "h-5 w-5" }) }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(SheetContent, { className: "overflow-y-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(SheetHeader, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(SheetTitle, { children: "Settings" }) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-6 mt-6", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(APIKeyInput, {}),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4 border-t pt-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-900 mb-1", children: "Current Model" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-gray-600", children: getCurrentModel() })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-medium text-gray-900", children: "System Prompt" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  Textarea,
                  {
                    value: prompt,
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { onClick: handleSavePrompt, variant: "outline", className: "w-full", children: "Save Prompt" })
              ] })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "border-t pt-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              AddRuleForm,
              {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-white rounded-lg shadow-sm p-6", children: /* @__PURE__ */ jsxRuntimeExports.jsx(SubjectInput, { value: subject, onChange: setSubject }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(RuleBoard, { subject })
  ] }) });
};
const NotFound = () => {
...
//# sourceMappingURL=index-DdH8eK4D.js.map
